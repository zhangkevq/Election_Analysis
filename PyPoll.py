...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes: #iterate through the candidate list
        ...
        print(candidate_results) #print each candidate, vote count, and %
        txt_file.write(candidate_results) #save candidate results to txt file
        ...
        if (votes > winning_count) and (vote_percentage > winning_percentage):
            ...
            winning_count = votes
            winning_candidate = candidate_name #set winning candidate equal to candidate's name
